...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      {/* අලුත් වම් පැත්ත (New Left Side): Branding/Testimonial */}
        ...
        <div className="relative z-10 text-white max-w-lg">
          ...
          <div className="bg-white/10 p-6 rounded-2xl backdrop-blur-md border border-white/20 shadow-2xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="h-2.5 w-32 bg-white/60 rounded-full"></div>
            </div>
            <div className="flex items-center gap-4 mb-4">
              <div className="w-5 h-5 rounded-full bg-green-400"></div>
              <div className="h-2.5 w-48 bg-white/80 rounded-full"></div>
            </div>
      ...
      {/* අලුත් දකුණු පැත්ත (New Right Side): Form Section */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative overflow-y-auto">
        <div className={`max-w-md w-full transition-all duration-1000 ${isMounted ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"}`}>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 mt-2 text-sm">Join thousands of teams managing tasks efficiently.</p>
          </div>

          <div className="flex gap-4 mb-6">
            <button className="flex-1 flex items-center justify-center gap-2 border border-gray-300 rounded-xl py-2.5 font-medium text-gray-700 hover:bg-gray-50 transition shadow-sm">
